 ...
 * JSON types
 */
export type { AccountlessApplicationJSON, ClerkResourceJSON, TokenJSON, AllowlistIdentifierJSON, BlocklistIdentifierJSON, ClientJSON, EmailJSON, EmailAddressJSON, ExternalAccountJSON, IdentificationLinkJSON, InvitationJSON, JwtTemplateJSON, OauthAccessTokenJSON, OrganizationJSON, OrganizationDomainJSON, OrganizationDomainVerificationJSON, OrganizationInvitationJSON, PublicOrganizationDataJSON, OrganizationMembershipJSON, OrganizationMembershipPublicUserDataJSON, PhoneNumberJSON, ProxyCheckJSON, RedirectUrlJSON, SessionJSON, SignInJSON, SignInTokenJSON, SignUpJSON, SMSMessageJSON, UserJSON, VerificationJSON, WaitlistEntryJSON, Web3WalletJSON, DeletedObjectJSON, PaginatedResponseJSON, TestingTokenJSON, WebhooksSvixJSON, } from './api/resources/JSON';
/**
 * Resources
 */
export type { AccountlessApplication, AllowlistIdentifier, BlocklistIdentifier, Client, EmailAddress, ExternalAccount, Invitation, JwtTemplate, OauthAccessToken, Organization, OrganizationDomain, OrganizationDomainVerification, OrganizationInvitation, OrganizationMembership, OrganizationMembershipPublicUserData, PhoneNumber, Session, SignInToken, SMSMessage, Token, User, TestingToken, } from './api/resources';
/**
